...
export const MOCK_PSYCHOLOGISTS: Psychologist[] = [
  {
    ...
    bio: "Dr. Jenkins specializes in CBT for adults struggling with anxiety and work-life balance. She has over 12 years of experience in clinical settings.",
  ...
  },
  {
    ...
    bio: "Michael focus on relational dynamics and trauma-informed care. He works with families to build bridges of understanding.",
  ...
  },
  {
    ...
    bio: "Dr. Rodriguez is a board-certified child psychologist with a passion for supporting neurodivergent youth and their families.",
